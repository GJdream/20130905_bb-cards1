...
- (void)loadView {
    ...
    UIImageView *labelimage3 = [[UIImageView alloc] initWithFrame:contentView.frame];
	labelimage3.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@.png",
                                             theDataObject.passPhotoInThirdVC]];
    [contentView addSubview:labelimage3];
    [contentView release];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    NSLog(@"at ThirdViewController touchesBegan");
